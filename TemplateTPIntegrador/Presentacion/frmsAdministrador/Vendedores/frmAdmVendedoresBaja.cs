...
{
    public partial class frmAdmVendedoresBaja : Form
    {
        public UsuarioWS usuario;
        
        public frmAdmVendedoresBaja()
        {
            InitializeComponent();
        }
        ...
        private void btnEliminarVendedor_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DialogResult dialogResult = MessageBox.Show($"¿Está seguro que desea eliminar al usuario vendedor: {usuario.NombreUsuario}?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                ...
                LimpiarCamposBaja();
                MessageBox.Show($"Usuario Vendedor: {usuario.NombreUsuario} eliminado con éxito.", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                usuario = null;
            }
            catch (Exception ex)
            {
